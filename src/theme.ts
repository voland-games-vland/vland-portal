...
const buttonClassification = {
  wrapper: 'mb-1',
  input:
    'bg-gray-500 hover:bg-gray-700 text-white text-sm font-normal py-3 px-5 rounded-sm',
}
...
export default {
  ...
  file: {
    ...
    input:
      'text-gray-600 text-sm mb-1 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:bg-gray-500 file:text-white hover:file:bg-gray-600',
    noFiles: 'block text-gray-800 text-sm mb-1',
    fileItem: 'block flex text-gray-800 text-sm mb-1',
    fileRemove: 'ml-auto text-gray-500 text-sm',
  },
