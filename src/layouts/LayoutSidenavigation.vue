    ...
    <div class="drawer drawer-mobile">
        ...
        <div class="drawer-side">
            ...
            <ul class="menu p-4 w-80 bg-base-300 text-base-content font-bold uppercase gap-2">
                ...
                <li>
                    <RouterLink to="/play" class="text-xl" active-class="active">
                        <div>
                ...
                <li>
                    <RouterLink to="/maps" class="text-xl" active-class="active">
                        <div>
                ...
                <li>
                    <RouterLink to="/clans" class="text-xl" active-class="active">
                        <div>
                ...
                <li>
                    <RouterLink to="/market" class="text-xl" active-class="active">
                        <div>
                ...
                <div class="flex mt-auto font-normal text-sm normal-case">© {{ currentYear }} Jonas Voland</div>
            </ul>
        </div>
    </div>
</template>
