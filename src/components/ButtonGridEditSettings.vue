<template>
    <label class="btn btn-square btn-sm" for="grid-edit-modal">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            enable-background="new 0 0 32 32" id="Editable-line" version="1.1" viewBox="0 0 32 32"
            xml:space="preserve" stroke="currentColor" width="20" height="20">
            ...
            <path
                ...
                fill="none" id="XMLID_242_" stroke-linecap="round" stroke-linejoin="round"
